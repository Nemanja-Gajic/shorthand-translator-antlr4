...
// Route, site, timing, and frequency tokens
...
// Fractional duration tokens
FRACTIONAL_DAY_DURATION : NUMBER '/7' ;
FRACTIONAL_WEEK_DURATION : NUMBER '/52' ;
FRACTIONAL_MONTH_DURATION : NUMBER '/12' ;

// Generic word token for unrecognized words (defined last to ensure lower precedence)
WORD   : [a-z]+ ;
...
frequency
    : QD | UD | BID | TID | QID | QOD | QAM | QMO | QPM | QHS | QMN | QXH | TIW | BIW | QW | QMW | STAT | PRN | ONCE | TWICE | THRICE | FREQUENCY_PER_DAY | FREQUENCY_PER_WEEK | FREQUENCY_PER_MONTH | FREQUENCY_PER_YEAR | FREQUENCY_PER_HOUR | FREQUENCY_PER_MINUTE | QXD | QXW | QXM | QXMIN ;

timing
    : BEFORE_MEALS | AFTER_MEALS | AT_BEDTIME | WITH_MEALS | ON_EMPTY_STOMACH | AC | PC | HS | WC ;

duration
    : (X_DURATION | FOR_DURATION | SIMPLE_DURATION | UNTIL_FINISHED | CONTINUOUSLY | LIFELONG | FRACTIONAL_DAY_DURATION | FRACTIONAL_WEEK_DURATION | FRACTIONAL_MONTH_DURATION)
    ;
