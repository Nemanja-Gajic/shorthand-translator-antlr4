...
FRACTIONAL_YEAR_DURATION : NUMBER '/12' ;
...
duration
    : (X_DURATION | FOR_DURATION | SIMPLE_DURATION | UNTIL_FINISHED | CONTINUOUSLY | LIFELONG | FRACTIONAL_DAY_DURATION | FRACTIONAL_WEEK_DURATION | FRACTIONAL_YEAR_DURATION)
    ;
